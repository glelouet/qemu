...
const char *MirrorSyncMode_lookup[] = {
    ...
    [MIRROR_SYNC_MODE_DIRTY_BITMAP] = "dirty-bitmap",
...
const char *RunState_lookup[] = {
    ...
    [RUN_STATE_CHECKPOINT_VM] = "checkpoint-vm",
    [RUN_STATE_MAX] = NULL,
};
...
const char *MigrationStatus_lookup[] = {
    ...
    [MIGRATION_STATUS_CHECKPOINTING] = "checkpointing",
...
const char *MigrationCapability_lookup[] = {
    ...
    [MIGRATION_CAPABILITY_MC] = "mc",
    [MIGRATION_CAPABILITY_MC_NET_DISABLE] = "mc-net-disable",
    [MIGRATION_CAPABILITY_MC_RDMA_COPY] = "mc-rdma-copy",
    [MIGRATION_CAPABILITY_RDMA_KEEPALIVE] = "rdma-keepalive",
...
void qapi_free_MCStatsList(MCStatsList *obj)
{
    QapiDeallocVisitor *md;
    Visitor *v;
    ...
    md = qapi_dealloc_visitor_new();
    v = qapi_dealloc_get_visitor(md);
    visit_type_MCStatsList(v, &obj, NULL, NULL);
    qapi_dealloc_visitor_cleanup(md);
}


void qapi_free_MCStats(MCStats *obj)
{
    QapiDeallocVisitor *md;
    Visitor *v;
    ...
    md = qapi_dealloc_visitor_new();
    v = qapi_dealloc_get_visitor(md);
    visit_type_MCStats(v, &obj, NULL, NULL);
    qapi_dealloc_visitor_cleanup(md);
}
